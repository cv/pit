...
- no WASI imports are linked; and
...
The next spike must preserve Pit's TypeScript authoring model. It will evaluate compiled JavaScript in a QuickJS/Javy WASM guest and prove an asynchronous host-call message pump before this addon can implement `FunctionExecutor`.
