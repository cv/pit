...
export const PROMPT_GUIDELINES = [
  ...
  "In typescript, use workspace.read in hashed mode before editing, workspace.edit with revision-checked anchors for changes, and workspace.batch for concurrent reads or transactional edits.",
