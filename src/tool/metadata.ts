...
export const PROMPT_GUIDELINES = [
  ...
  "Before an anonymous typescript call, compare recent work and saved functions. Define or extend one parameterized named function when work repeats or is likely to recur; otherwise stay anonymous. Persist explicitly with functions.promote(name, summary) or /functions.",
