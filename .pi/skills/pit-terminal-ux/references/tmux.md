...
- Cancellation through a real Escape key, the resulting UI state, and a process-existence probe using the observed fixture PID. Verify the child is gone; a label alone is not cancellation evidence.
